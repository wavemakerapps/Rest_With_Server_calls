...
package com.sample1.services.connectpoint_reservation;
 ...
 * 2018-01-09T06:19:04.944Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "ConnectPoint_Reservation", 
                  wsdlLocation = "ConnectPoint_Reservation.wsdl",
...
public class ConnectPointReservation extends Service {
    ...
    static {
        URL url = ConnectPointReservation.class.getResource("ConnectPoint_Reservation.wsdl");
        if (url == null) {
            url = ConnectPointReservation.class.getClassLoader().getResource("ConnectPoint_Reservation.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(ConnectPointReservation.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "ConnectPoint_Reservation.wsdl");
        }       
        WSDL_LOCATION = url;
    }
